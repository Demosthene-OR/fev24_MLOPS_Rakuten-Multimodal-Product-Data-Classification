...
if st.session_state.docker: 
    ...
    # MODIFIED FOR HUGGING FACE MONOLITH
    # Services are on localhost within the container
    st.session_state.users_db = "127.0.0.1"
    st.session_state.api_oauth = "127.0.0.1"
    st.session_state.api_predict = "127.0.0.1"
    st.session_state.api_train = "127.0.0.1"
    st.session_state.api_flows = "127.0.0.1"
